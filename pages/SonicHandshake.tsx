        ...
        <div className="min-h-screen bg-[#1A1A1A] text-white flex flex-col relative overflow-hidden font-sans">
            ...
            <div className="pt-14 px-6 flex items-center justify-between relative z-20 mb-8">
                ...
                <div className="flex flex-col items-center">
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 mb-1">Stellar Sonic</span>
                    <div className="flex items-center gap-1.5 px-3 py-1 bg-green-500/10 border border-green-500/20 rounded-full">
                        <div className="w-1 h-1 bg-green-500 rounded-full animate-pulse"></div>
                        <span className="text-[9px] font-black uppercase tracking-widest text-green-500">Live Engine</span>
                    </div>
                </div>
                <button
                    onClick={() => alert("Sonic Handshake uses sound waves to transfer your UPI ID to nearby devices without internet access or QR codes.")}
                    className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 active:scale-95 transition-all text-zinc-400 hover:text-white"
                >
                    <Info size={22} />
                </button>
            ...
            <div className="flex-1 px-6 flex flex-col items-center justify-center relative z-10 pb-20">
                <div className="w-full max-w-sm mb-12">
                    <h2 className="text-3xl font-black text-center mb-4 tracking-tighter">Proximity Pay</h2>
                    <p className="text-zinc-500 text-center text-sm font-medium leading-relaxed px-4">
                        Transfer your identity through the air. Secure, contactless, and futuristic.
                    </p>
                </div>
                ...
                <div className="mt-12 flex flex-col items-center">
                    <div className="flex items-center gap-8 mb-4">
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <span className="text-[8px] font-black text-zinc-600 uppercase tracking-widest">Audible</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <span className="text-[8px] font-black text-zinc-600 uppercase tracking-widest">Encoded</span>
                        </div>
                    </div>
                    <p className="text-[9px] text-zinc-600 font-bold uppercase tracking-[0.2em]">End-to-End Sonic Encryption</p>
                </div>
            </div>
        </div>
    );
