        ...
        >
            <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                    <p className="text-xs font-black uppercase tracking-[0.2em] text-white/70 -500 mb-0.5">Stellar Rewards</p>
                    <p className="text-sm font-bold text-white/30">You have rewards to claim</p>
                </div>
            </div>
